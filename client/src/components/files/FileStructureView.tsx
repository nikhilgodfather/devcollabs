...
function FileStructureView() {
    ...
    const [showUploadHandler, setShowUploadHandler] = useState(false)
    ...
    return (
        <div onClick={handleClickOutside} className="flex flex-grow flex-col">
                    ...
                    {!isViewer && (
                        <>
                            ...
                            <button
                                className="rounded-md px-1 hover:bg-darkHover"
                                onClick={() =>
                                    setShowUploadHandler(!showUploadHandler)
                                }
            ...
            {showUploadHandler && !isViewer && (
                <div className="border-b border-darkHover p-3">
                    <FileUploadHandler
                        parentDirId={fileStructure.id}
                        onUploadComplete={() => setShowUploadHandler(false)}
                    />
                </div>
            )}
            <div
...
function Directory({
    ...
    return (
        <div className="overflow-x-auto">
            ...
            {menuOpen && !currentUser.role && currentUser.role !== "VIEWER" && (
                <DirectoryMenu
